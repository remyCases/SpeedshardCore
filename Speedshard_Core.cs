...
public class SpeedshardCore : Mod
{
    ...
    {
        Msl.LoadGML("gml_GlobalScript_scr_globaltile_reputation_calc")
            .MatchFrom("if (argument0 > 0)\n{")
            .InsertBelow("argument0 = (global.reputation_modifier * argument0)")
            .Save();
    }
    ...
    public static void XpDistribution()
    {
        Msl.LoadAssemblyAsString("gml_Object_o_player_Step_0")
            .MatchFromUntil("pushi.e 250", "mul.v.i")
            .ReplaceBy("pushglb.v global.xp_by_level_modifier\npushloc.v local._lvl\nmul.v.v")
            .Save();
    }
    public void MoreSPAP()
    {
        Msl.LoadAssemblyAsString("gml_Object_o_player_Step_0")
            .MatchFromUntil("push.s \"AP\"", "popz.v")
            .InsertBelow(ModFiles, "more_ap_by_level.asm")
            .MatchFromUntil("push.s \"SP\"", "popz.v")
            .InsertBelow(ModFiles, "more_sp_by_level.asm")
            .Save();
    }
    public static void MaxLevel()
    {
        ...
        Msl.LoadAssemblyAsString("gml_Object_o_character_panel_mask_Draw_0")
            .MatchFrom("pushi.e 30\ncmp.i.v EQ")
            .ReplaceBy("pushglb.v global.max_level\ncmp.v.v EQ")
            .Save();
    }
    ...
    public void Campbed()
    {
        Msl.LoadAssemblyAsString("gml_Object_c_bed_sleep_crafted_Alarm_0")
            .MatchFrom("pushi.e 1\ncmp.i.v GTE")
            .ReplaceBy("pushglb.v global.campbed_despawn_days\ncmp.v.v GTE")
            .Save();
